...
<div class="well well-sm text-right">
    <a class="btn btn-info" href="?c=pedido&a=Crud"> Pedido</a><!--INDICA QUE CONTROLADOR Y QUE ACCION EJECUTAR, EN ESTE CASO LLAMARIA AL ARCHIVO USUARIO.CONTROLLER.PHP Y ESTE A LA FUNCION CRUD DE ESE ARCHIVO QUE NECESITA DE HEADER, USUARIO-EDITAR Y FOOTER--->
</div>
    <div class="well well-sm text-right">
...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th style="width:180px;">Fecha de tu pedido. </th>
            <th style="width:100px;">Hora de tu pedido. </th>
            <th style="width:100px;">Que quieres pedir.</th>
            <th style="width:100px;">Cantidad.</th>
            <th style="width:60px;">Instrucciones especiales de tu pedido.</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-info" href="?c=pedido&a=Crud&id=<?php echo $r->id; ?>">Editar</a><!--INDICA QUE CONTROLADOR Y QUE ACCION EJECUTAR, EN ESTE CASO LLAMARIA AL ARCHIVO ALUMNO.CONTROLLER.PHP Y ESTE A LA FUNCION CRUD DE ESE ARCHIVO QUE NECESITA DE HEADER, ALUMNO-EDITAR Y FOOTER--->
            </td>
            <td>
                <a class="btn btn-info" onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=pedido&a=Eliminar&id=<?php echo $r->id; ?>">Eliminar</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
